...
<div id="tribes-list-container">
  ...
  for($i = 0; $i < $details->count; $i++) {
    ...
    //echo '    </div>';
    //<!--  TITLE HERE  -->
    echo '    <div class="tribe-single-title-container background-red custom-title-overflow overflow-red row">';
    echo '      <div class="tribe-single-title anton text-white text-center">';
    echo $el->title;
    echo '      </div>';
    echo '    </div>';
    //<!-- LOGO HERE -->
    echo '    <div class="tribe-single-logo-container row background-grey">';
    ...
    echo '        <img class="tribe-single-logo row" src="' . SITE_ROOT . $image_dir . '/' . $el->logo . '" />';
    //echo '      </a>';
    echo '    </div>';
